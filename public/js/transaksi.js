...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  methods: {
    ...
    sendOrder: function sendOrder() {
      ...
      this.errorMessage = '';
      this.message = ''; //jika var customer.email dan kawan2nya tidak kosong
      ...
      if (this.customer.email != '' && this.customer.name != '' && this.customer.phone != '' && this.customer.address != '') {
        ...
        this.$swal({
          ...
          if (result.value) {
            ...
            _this7.submitForm = true; //kirimkan datanya ke uri checkout
            ...
            axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('checkout', _this7.customer).then(function (response) {
              setTimeout(function () {
                ...
                _this7.getCart(); //message diset untuk ditampilkan
...
module.exports = __webpack_require__(/*! D:\xampp\htdocs\point-of-sales\resources\assets\js\transaksi.js */"./resources/assets/js/transaksi.js");
